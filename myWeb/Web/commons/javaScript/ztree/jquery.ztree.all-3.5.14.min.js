...
(function(u){
                    ...
                    if(h.apply(e.callback.beforeDrop,[i.treeId,l,q,w,p],!0)== !1)f.selectNodes(x,l);else{
                        ...
                        a=function(){
                            if(I){
                                ...
                                if(w==d.move.TYPE_INNER)f.addNodes(i,q,s);else if(f.addNodes(i,q.getParentNode(),s), w==d.move.TYPE_PREV)for(a=0, c=s.length; a<c; a++)f.moveNode(i,q,s[a],w,!1);else for(a= -1, c=s.length-1; a<c; c--)f.moveNode(i,q,s[c],w,!1)
    ...
    u.extend(!0,u.fn.zTree._z,{tools:{getAbs:function(b){
                ...
                addRemoveBtn:function(b,a){
                    ...
                    if(g){
                        ...
                        if(h.apply(b.callback.beforeRename,[b.treeId,g,j,e],!0)=== !1)return!1;else g[n]=j?j:k.val(), b.treeObj.trigger(d.event.RENAME,[b.treeId,g,e]);
    ...
    m.addZTreeTools(function(b,a){
        ...
        a.moveNode=function(a,n,g,k){
            ...
            if(!n)return n;
            if(a&& !a.isParent&&b.data.keep.leaf&&g===d.move.TYPE_INNER)return null;else if(a&&(n.parentTId==a.tId&&g==d.move.TYPE_INNER||o(n,b).find("#"+a.tId).length>0))return null;else a||(a=null);
