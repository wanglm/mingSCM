    ...
    if(window.Select2===g){
        ...
        w=x(Object,{bind:function(a){
            ...
            highlightUnderEvent:function(a){
                ...
                0!==b.length&&(c=b.offset().top-a.offset().top-a.height(), 0>=c&&(b.addClass("select2-active"), this.opts.query({term:f,page:d,context:g,matcher:this.opts.matcher,callback:this.bind(function(c){
